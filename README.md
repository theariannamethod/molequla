...
- Mitosis: adults divide under sustained overload (loss path and entropy path both fire), child inherits parent weights — machine-verified on GPU 2026-06-04 (five gate firings across three adults; Fire's divide preserved in full with child manifest; observed cascading to ~50 spawns)
